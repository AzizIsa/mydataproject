...
const routes: Routes = [
    ...
    { path: 'charts', component: MapPage, data: { title: 'Chart'} },

  //////////////////////////////************My Page*****************//////////////////////////////////
    { path: 'fundamentals', component: Fundamentals, data: { title: 'Fundamentals'} },
    { path: 'technicals', component: Technicals, data: { title: 'Technicals'} },
    { path: 'sentiment', component: Sentiment, data: { title: 'Sentiment'} },
    { path: 'scanner', component: Scanner, data: { title: 'Scanner'} },
    { path: 'economics', component: Economics, data: { title: 'Economics'} },
    { path: 'crystals', component: Crystals, data: { title: 'Crystals'} },
